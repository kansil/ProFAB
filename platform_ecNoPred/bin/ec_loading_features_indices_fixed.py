...
def import_data(dataset_name,split_type):
    ...
    pos_test = np.loadtxt(dataset_name +  '/' + split_type + '/test_positive_set_PAAC.txt',dtype = '<U11')
    neg_test = np.loadtxt(dataset_name +  '/' + split_type + '/test_negative_set_PAAC.txt',dtype = '<U11')
    pos_valid = np.loadtxt(dataset_name +  '/' + split_type + '/valid_positive_set_PAAC.txt',dtype = '<U11')
    neg_valid = np.loadtxt(dataset_name +  '/' + split_type + '/valid_neagtive_set_PAAC.txt',dtype = '<U11')
